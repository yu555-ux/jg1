                ...
                <div>
                  ...
                  <div className="flex flex-col gap-6 md:flex-row">
                    <div className="w-full shrink-0 space-y-4 md:w-40">
                      ...
                      <button
                        className={`w-full rounded-2xl border px-4 py-3 text-sm tracking-wide transition-colors ${luckSelectMode === 'highest'
                      ...
                      <button
                        className={`w-full rounded-2xl border px-4 py-3 text-sm tracking-wide transition-colors ${luckSelectMode === 'secondary'
                    ...
                    <div className="flex-1 space-y-4">
                      <div className="text-sm text-teal-100">
                        {luckPoolKey} · {luckSelectMode === 'highest' ? '最高级奖品' : '次高级奖品'}
                      </div>
